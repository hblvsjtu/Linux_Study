...
------    
 ...
   想想自己以后多半在Linux环境中摸爬滚打了，学习Linux的基本操作必不可少。半年前我学了一半，但是由于一些原因中断了学习。后来学C和Node.js等后端语言的时候，明显感受到shell命令行和Linux环境对于开发的重要性。所以后面打算再补三章的内容：script和软件安装和Linux中常见的网络命令^_ ^
...
## [七、 Linux文件与目录管理](#7)
### [7.1 目录的相关操作](#7.1)
### [7.2 关于执行文件路径的变量：$PATH](#7.2)   
### [7.3 文件内容查阅](#7.3)
### [7.4 修改文件时间或创建新文件：touch](#7.4)   
### [7.5 文件的默认权限与隐藏属性与特殊权限](#7.5)
### [7.6 命令和文件的查询](#7.6)   
...
### [8.5 目录树与其他文件系统](#8.5)
### [8.6 文件系统的简单操作](#8.6)
### [8.7 磁盘的分区，格式化，检验和挂载](#8.7)
        
## [九、 文件与文件系统的压缩与打包](#9)
### [9.1 常见的压缩命令](#9.1)
### [9.2 完整的备份工具dump和恢复工具restore](#9.2)   
                
## [十、 vim程序编辑工具](#10)
### [10.1 vi与vim](#10.1)
### [10.2 一些常用的命令](#10.2)   
### [10.3 Vim的文件保存，恢复与打开时的警告信息](#10.3)
### [10.4 其他操作与语系转换](#10.4)
            
## [十一、 bash](#11)
### [11.1  硬件，内核，shell和bash的关系](#11.1)
### [11.2 shell的变量功能](#11.2)   
### [11.3 Bash shell的操作环境](#11.3)
### [11.4 Bash shell的环境配置文件（太复杂了，不看）](#11.4)   
### [11.5 数据的重定向](#11.5)
### [11.6 命令与管道命令](#11.6)  
...
### [12.2 拓展正则表达式](#12.2)
### [12.3 sed工具](#12.3)
### [12.4 格式化打印：printf](#12.4)
### [12.5 awk：好用的数据处理工具](#12.5)
### [12.6 文件比较工具](#12.6)
